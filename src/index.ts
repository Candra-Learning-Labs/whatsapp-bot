...
//INFO: not worked out yet, it seems that the baileys library is not stable yet and not production ready.
// in the github repo there's many (reoccuring) unanswered question and issues.
// so, finger crossed. i'm leaving this project for now
